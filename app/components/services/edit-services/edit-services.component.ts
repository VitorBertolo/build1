...
import { Order, User } from "../../users/shared/user";
...
export class EditServicesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.route.params.subscribe((params) => {
      ...
      this.orders$ = this.db
        .list(`users-list/${this.serviceId}/orders`)
        .valueChanges()
        .pipe(
          map((orders) => {
    ...
    this.getOrdersByService(this.serviceId).subscribe((orders) => {
      this.orders$ = this.db
        .list<Order>("services-list/" + this.serviceId + "/orders")
        .valueChanges();
    });
  ...
  get cidade_treinamento() {
    return this.editForm.get("cidade_treinamento");
  }
  ...
  get hora_total() {
    return this.editForm.get("hora_total");
  }
  ...
  get empresa_lista() {
    return this.editForm.get("empresa_lista");
  }
